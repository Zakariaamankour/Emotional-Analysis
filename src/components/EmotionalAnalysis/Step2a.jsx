        ...
        <div className="step2a">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                    <div className="step2a-second-section-right">
                        ...
                        <div className="step2a-second-section-right-left">
                            <div className="step2a-second-section-right-left-item">
                                <div className="step2a-second-section-right-left-item-title"  >Prominent Emotion</div>
                                <div className="step2a-second-section-right-left-item-text"  >Happiness</div>

                                <div className="step2a-second-section-right-left-item-footer">
                                    <div className="step2a-second-section-right-left-item-footer-text"  >Why is this important</div>
                                    <img className="step2a-second-section-right-left-item-footer-img" src="../images/questionicon.png" alt="" />
                                </div>
                            </div>

                            <div className="step2a-second-section-right-left-item">
                                <div className="step2a-second-section-right-left-item-title"  >Accent Emotion</div>
                                <div className="step2a-second-section-right-left-item-text"  >Anger</div>
                        ...
                        <div className="step2a-second-section-right-right">
                            ...
                            <div className="step2a-button" style={{ width: "auto", padding: "10px 20px" }}>
            ...
            <div className="step2a-fourth-section">
                ...
                <div className="step2a-fourth-section-rigth">
                    <div className="step2a-fourth-section-rigth-top">
                        ...
                        <div className="step2a-fourth-section-rigth-right">
                            <div className="step2a-fourth-section-rigth-left-item">
                                <div className="step2a-fourth-section-rigth-left-item-left">
