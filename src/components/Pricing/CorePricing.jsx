    ...
    return (
        <div className="ElevatePricing">
            <div className="ElevatePricing-header">
                <p className="ElevatePricing-header-title">Core</p>
                <p className="ElevatePricing-header-text">Data driven tool to tailor your success.</p>
            ...
            <div className="ElevatePricing-top">
                ...
                <div className="CorePricing-top-right">
                    <p className="CorePricing-top-right-title">
                        Core
                    </p>
                    <p className="CorePricing-top-right-texte">
                        Getting Started
                    </p>
                </div>
            </div>
