        ...
        <div className='home-section'>
            ...
            <div className="homepage-2">
                ...
                <div class="emotional-container">
                    <div style={{ borderBottom: '1px #777777 solid', padding: "5px" }}>
                        <div class="emotional-text">Emotional Unlock </div>
                    </div>
                    <div style={{ borderBottom: '1px #777777 solid', padding: "5px" }}>
                        <div class="emotional-text active">Competitor Insights</div>
                    </div>
                    <div style={{ borderBottom: '1px #777777 solid', padding: "5px" }}>
                        <div class="emotional-text">Audience Expansion</div>
                    </div>
                </div>
                    ...
                    <div className='emetional-analysis-left'>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "linear-gradient(180deg, #AEDCEE 0%, #F1F5F6 100%)" }}>
                            <div style={{ textAlign: "center" }}>
                                <span class="emotional-text">Emotional</span>
                            ...
                            <img class="analysis-img" src="../images/analysis.png" />


                            <div class="button-container">
                                <button class="button white-button">
                                    <div class="button-text white-text">Discover More</div>
                                </button>
                                <button class="button blue-button">
                                    <div class="button-text blue-text">Sign Up</div>
                                </button>
                            </div>
                        </div>
                        <div className='emetional-analysis-item' style={{ background: "white" }}>
                            <div className='emetional-text'>
                                ...
                                <span style={{ color: '#000080', fontSize: 32, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Tracker</span>
                            </div>
                            <div class="description-text">Compare, evaluate, refine..</div>


                            <img class="analysis-img" src="../images/search.svg" style={{ width: "157px", height: "180.65px", padding: "30px 0" }} />
                        ...
                        <div className='emetional-analysis-item' style={{ background: "#FAFAFA" }}>
                            <div className='emetional-text'>                                <span style={{ color: 'rgba(114.05, 127.21, 226.85, 0.50)', fontSize: 32, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Audience</span>
                    ...
                    <div className='emetional-analysis-right'>
                        ...
                        <div className='emetional-analysis-item ' style={{ background: "black" }}>
                            ...
                            <div>
                                ...
                                <span style={{ color: '#FB96A4', fontSize: 32, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Testing</span>
                            </div>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "#FAFAFA" }}>
                            ...
                            <div style={{ color: '#E57B15', fontSize: 32, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Playbook</div>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "white" }}>
                            ...
                            <div style={{ color: '#C61956', fontSize: 32, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Derivative</div>
            ...
            <div className="homepage-5">
                ...
                <div className='button-container-4'>
                    <div style={{ width: '25%', height: '100%', padding: 10, background: 'white', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', borderRadius: 20, border: '1px #0070FF solid', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
                    ...
                    <div style={{ width: '25%', height: '100%', padding: 10, background: '#0070FF', boxShadow: '0px 4px 4px rgba(0, 0, 0, 0.25)', borderRadius: 20, border: '1px #0070FF solid', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
            ...
            <div className="homepage-7">
                ...
                <div style={{ width: '100%', textAlign: 'center', padding: "20px 0" }}><span style={{ color: '#242424', fontSize: 42, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Take a closer look at our </span><span style={{ color: '#E57B15', fontSize: 42, fontFamily: 'Bumbbled', fontWeight: 400, wordWrap: 'break-word' }}>models</span></div>
                ...
                <div className='emetional-analysis'>
                    <div className='emetional-analysis-left'>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "black" }}>
                            <div style={{ color: '#C4D5DF', fontSize: 100, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Elevate</div>
                            <div style={{ color: 'white', fontSize: 24, fontFamily: 'Eloquia Display', fontWeight: 400, wordWrap: 'break-word' }}>Professionals</div>


                            <div className='emetional-analysis-buttons' style={{ display: "flex", width: "40%", padding: "30px" }}>
                                <div style={{ width: '100%', height: '100%', padding: 10, borderRadius: 20, border: '1px #0070FF solid', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
                                    <div style={{ color: '#0070FF', fontSize: 12, fontFamily: 'Poppins', fontWeight: 400, wordWrap: 'break-word' }}>See all benefits</div>
                                </div>
                                <div style={{ width: '100%', height: '100%', padding: 10, borderRadius: 20, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex' }}>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "#FDFDFD" }}>
                            <div style={{ color: '#94C5F4', fontSize: 100, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Core</div>
                    ...
                    <div className='emetional-analysis-right'>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "#FAF9F9" }}>
                            <div style={{ color: '#EF4C2D', fontSize: 100, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Evolve</div>
                        ...
                        <div className='emetional-analysis-item' style={{ background: "#FAF9F9" }}>
                            <div style={{ color: '#777777', fontSize: 100, fontFamily: 'Eloquia Display', fontWeight: 600, wordWrap: 'break-word' }}>Basic</div>
